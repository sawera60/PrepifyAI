                ...
                <div className="relative w-full max-w-md bg-[#13151F] border border-white/[0.08] rounded-2xl p-8 shadow-2xl">
                    ...
                    <div className="mb-7">
                        ...
                        <p className="text-[#8B89A0] text-sm mt-1.5 leading-relaxed">
                            Practice real interviews with AI and land your dream job.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                    ...
                                    required
                                    className="bg-[#1A1D2A] border border-white/[0.08] text-white text-sm placeholder-[#5A5870] rounded-lg px-3.5 py-2.5 outline-none transition-all duration-150 focus:border-[#6C63FF]/60 focus:ring-1 focus:ring-[#6C63FF]/30"
                                />
                            </div>
                            <div className="flex flex-col gap-1.5">
                                <label
