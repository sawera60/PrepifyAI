...
const Herosection = () => {
    ...
    return (
        <section className="font-dm relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#13151F] via-[#13151F] to-[#1A1D2A] border border-white/[0.06] py-5 px-6 md:py-6 md:px-8 mt-4">
            {/* Background glow */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {/* Subtitle */}
                    <p className="text-[#8B89A0] text-sm leading-relaxed max-w-md mb-4">
                ...
                <div className="flex-shrink-0 relative">
                    ...
                    <img
                        ...
                        className="relative z-10 w-[140px] md:w-[170px] h-auto rounded-2xl object-cover"
                    />

                    {/* Chat bubble */}
                    <div className="absolute top-2 -left-16 md:top-6 md:-left-40 z-20 bg-[#1A1D2A] border border-white/[0.1] rounded-xl px-4 py-3 max-w-[200px] shadow-xl">
